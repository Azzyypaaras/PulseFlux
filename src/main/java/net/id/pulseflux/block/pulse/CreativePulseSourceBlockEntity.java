...
public class CreativePulseSourceBlockEntity extends PulseBlockEntity implements IoProvider {

    @NotNull private Optional<RelativeObjectData<PulseIo>> child = Optional.empty();
    private int renderTicks = -25;

    public CreativePulseSourceBlockEntity(BlockPos pos, BlockState state) {
        super(PulseFluxBlockEntities.CREATIVE_PULSE_SOURCE_TYPE, DefaultMaterials.DIAMOND, pos, state, 20);
    }
